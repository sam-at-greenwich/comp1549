        ...
        public void run() {
            try {
                ...
                for (PrintWriter writer : writers) {
                    ...
                    convo.add("MESSAGE " + name + " has joined");
                }
                writers.add(out);
                ...
                while (true) {
                    ...
                    for (PrintWriter writer : writers) {
                        writer.println("MESSAGE " + name + ": " + input + " (sent at " + new Date().toString() + ")");
                        convo.add("MESSAGE " + name + ": " + input + " (sent at " + new Date().toString() + ")");
                    }
                ...
                if (name != null) {
                    ...
                    for (PrintWriter writer : writers) {
                        ...
                        convo.add("MESSAGE " + name + " has left");
                    }
                }
